...
class ReportService:
    ...
    def generate_report(self, analysis_result: Dict[str, Any]) -> str:
        ...
        # ---- Header ----
        story.append(Paragraph("🛡️ MessageGuard Threat Vision — Forensic Report", title_style))
        ...
        story.append(Paragraph(
            f"This report was generated by MessageGuard Threat Vision | Case {case_id} | Hash {content_hash[:16]}",
            small_style,
        ))
